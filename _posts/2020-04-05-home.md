...
The ratio of expected infections to observed cases can be interpreted as the multiplication factor for a given state. For example, in Florida, the number of expected infections is 50 times the number of confirmed COVID-19 cases. The states with the highest discrepancy between estimated infections and confirmed case counts tended to have 
