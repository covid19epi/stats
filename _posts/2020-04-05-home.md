...
<div style="width:120%; margin-left:-10%;">
	<iframe src="assets/images/fig-testrates-state.png" style="max-width:100%; width:100%; height: 600px; border-width: 0px;"></iframe>
</div>
