...
<div class="post-top-meta">
	<span style="font-size: 0.85rem; font-style: italic; border-bottom: 1px solid rgba(0, 0, 0, .125); margin-bottom: 10px; padding-bottom: 10px; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol','Noto Color Emoji';">Authors: Sean L. Wu, Andrew Mertens, Yoshika Crider, Anna Nguyen, Nolan N. Pokpongkiat, Stephanie Djajadi, Anmol Seth, Michelle S. Hsiang, John M. Colford Jr., Art Reingold, Benjamin F. Arnold, Alan Hubbard, Jade Benjamin-Chung</span>
</div>
...
In March and April, 2020 COVID-19 testing increased from 0.9 to 11 per 1,000 in the U.S. However, there were large discrepancies in testing between states, with state-level testing rates of 16 per 1,000 in Kansas to 4 per 1,000 in Rhode Island.
...
Correcting for incomplete testing and imperfect diagnostic accuracy, we estimated that the total number of COVID-19 infections was 6,275,072 (19 per 1,000) by April 18, 2020. This number vastly exceeds the 721,245 confirmed cases (2 per 1,000) COVID-19 cases reported during that period. 
...
<div class="post-top-meta" style="line-height: 0.85rem; position: relative;">
	<span style="font-size: 0.6rem; top: -50px; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol','Noto Color Emoji'; position: absolute; top: -30px; margin-bottom: 20px;">
				Analyses include cumulative confirmed COVID-19 case counts up to April 18, 2020. Estimated SARS-CoV-2 infections were from a Bayesian probabilistic bias analysis to correct for incomplete testing and imperfect test accuracy. Estimated infections include both symptomatic and asymptomatic infections. In Panel A) the difference between confirmed case counts (yellow) and estimated infections (gray) reveals under-estimation of total SARS-CoV-2 infection burden according to our model. Rows are sorted by the number of confirmed cases per state. Quality of daily estimates of the number of tests performed varied by state; see Appendix Table 1 for details. 
	</span>
</div>
...
<div class="post-top-meta" style="line-height: 0.85rem; position: relative;">
	<span style="font-size: 0.6rem; top: -50px; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol','Noto Color Emoji'; position: absolute; top: -30px; margin-bottom: 20px;">
		Analyses include cumulative confirmed COVID-19 case counts up to April 18, 2020. Estimated infections were estimated using Bayesian probabilistic bias analysis to correct for incomplete testing and imperfect diagnostic accuracy. Estimated infections include both symptomatic and asymptomatic infections. Ratios in each state are colored by quintile, with the darkest shade of blue indicating the largest quintile, and the lightest shade of green indicating the lowest quintile. Rows are sorted by the ratio of estimated infections to confirmed cases. Quality of daily estimates of the number of tests performed varied by state; see Appendix Table 1 for details. 
	</span>
</div>
...
Underestimation of SARS-CoV-2 infections was more common in California, the Midwest, and certain states in the south southern states.
