...
Below, estimated total COVID-19 infections -- including symptomatic and asymptomatic infections -- are shown in <span style="color:blue">(blue)</span>, and confirmed COVID-19 case counts are shown in <span style="color:green; font-weight:bold;">(green)</span>. Accounting for uncertainty in our model, the number of estimated infections in the U.S. was 3 to 14 times larger than the number of confirmed cases. 
